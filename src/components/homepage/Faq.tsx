...
const Faq = () => {
  const [openIndex, setOpenIndex] = useState(0); // Set second item open by default to match screenshot
  ...
  const faqContent = [
    ...
    {
      title:
        "Q. Can I customize Human Systems to match my company's HR processes?",
      content:
