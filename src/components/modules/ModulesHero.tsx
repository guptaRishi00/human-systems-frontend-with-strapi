...
export default function ModulesHero({ data }: { data?: any }) {
  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden rounded-b-[50px] min-h-[600px] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={fullHeroImage}
          alt={title || "Platform Modules Background"}
          fill
          priority
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="max-w-2xl mx-auto text-lg text-gray-700 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000">
          {description ||
            "From Core HR to Payroll — 9 powerful modules designed to streamline every aspect of your human resource operations with enterprise-grade security and multi-tenant architecture."}
        </p>
      </div>
